...
void BitcoinGUI::createActions()
{
    ...
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("Show/Hide &shitcoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the shitcoin window"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide shitcoin"
...
void BitcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
        ...
        labelMiningIcon->setToolTip(tr("Mining shitcoin at %1 hashes per second").arg(hashrate));
    }
    else
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_inactive").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Not mining shitcoin"));
    }
}
