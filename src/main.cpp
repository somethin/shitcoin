...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // shitcoin: 0.35 days
static const int64 nTargetSpacing = 15; // shitcoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal shitcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xceb5a350ea140c9434da419dd47436bb21aba1390926673c6b8467fdc3627382");
    }
	...
	//  nTime=1366559428, nBits=1e0ffff0, nNonce=386645545, vtx=1)
